...
echo "- grand_preceptor: $(grep -a "accou_courtier.0003 event option a, .*, position: grand_preceptor" debug.log | wc -l)"
echo "- grand_mentor: $(grep -a "accou_courtier.0003 event option a, .*, position: grand_mentor" debug.log | wc -l)"
echo "- grand_guardian: $(grep -a "accou_courtier.0003 event option a, .*, position: grand_guardian" debug.log | wc -l)"
echo "- fire_dragon_engineer: $(grep -a "accou_courtier.0003 event option a, .*, position: fire_dragon_engineer" debug.log | wc -l)"
echo "- keeper_of_the_harem: $(grep -a "accou_courtier.0003 event option a, .*, position: keeper_of_the_harem" debug.log | wc -l)"
echo "- favored_minister: $(grep -a "accou_courtier.0003 event option a, .*, position: favored_minister" debug.log | wc -l)"
echo "- minister_bureaucrat: $(grep -a "accou_courtier.0003 event option a, .*, position: minister_bureaucrat" debug.log | wc -l)"
echo "- court_guru: $(grep -a "accou_courtier.0003 event option a, .*, position: court_guru" debug.log | wc -l)"
echo "- court_brahmin: $(grep -a "accou_courtier.0003 event option a, .*, position: court_brahmin" debug.log | wc -l)"
echo "- khlon_glan: $(grep -a "accou_courtier.0003 event option a, .*, position: khlon_glan" debug.log | wc -l)"
echo "---"

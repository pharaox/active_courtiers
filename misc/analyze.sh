...
echo "- kurultai: $(grep -a "accou_courtier.0003 event option a, .*, position: kurultai" debug.log | wc -l)"
echo "---"
...
echo "- court_astrologer: $(grep -a "accou_courtier.0003 event option a, .*, position: court_astrologer" debug.log | wc -l)"
echo "- boyan: $(grep -a "accou_courtier.0003 event option a, .*, position: boyan" debug.log | wc -l)"
echo "- siege_engineer: $(grep -a "accou_courtier.0003 event option a, .*, position: siege_engineer" debug.log | wc -l)"
echo "- yurtchi: $(grep -a "accou_courtier.0003 event option a, .*, position: yurtchi" debug.log | wc -l)"
echo "- cherbi: $(grep -a "accou_courtier.0003 event option a, .*, position: cherbi" debug.log | wc -l)"
echo "- yeke_jarquchi: $(grep -a "accou_courtier.0003 event option a, .*, position: yeke_jarquchi" debug.log | wc -l)"
echo "- foreign_emissary: $(grep -a "accou_courtier.0003 event option a, .*, position: foreign_emissary" debug.log | wc -l)"

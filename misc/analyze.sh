...
echo "---"
echo "- chancellor: $(grep -a "accou_courtier.0003 event option b, .*, position: Chancellor" debug.log | wc -l)"
echo "- marshal: $(grep -a "accou_courtier.0003 event option b, .*, position: Marshal" debug.log | wc -l)"
echo "- steward: $(grep -a "accou_courtier.0003 event option b, .*, position: Steward" debug.log | wc -l)"
echo "- spymaster: $(grep -a "accou_courtier.0003 event option b, .*, position: Spymaster" debug.log | wc -l)"
echo "- court_chaplain: $(grep -a "accou_courtier.0003 event option b, .*, position: court_chaplain" debug.log | wc -l)"
echo "---"
echo "- court_physician: $(grep -a "accou_courtier.0003 event option b, .*, position: .*court_physician" debug.log | wc -l)"
echo "- cultural_emissary: $(grep -a "accou_courtier.0003 event option b, .*, position: cultural_emissary" debug.log | wc -l)"
echo "- keeper_of_swans: $(grep -a "accou_courtier.0003 event option b, .*, position: keeper_of_swans" debug.log | wc -l)"
echo "- chief_qadi: $(grep -a "accou_courtier.0003 event option b, .*, position: chief_qadi" debug.log | wc -l)"
echo "- garuda: $(grep -a "accou_courtier.0003 event option b, .*, position: garuda" debug.log | wc -l)"
echo "- court_gardener: $(grep -a "accou_courtier.0003 event option b, .*, position: court_gardener" debug.log | wc -l)"
echo "- lady_in_waiting: $(grep -a "accou_courtier.0003 event option b, .*, position: lady_in_waiting" debug.log | wc -l)"
echo "- antiquarian: $(grep -a "accou_courtier.0003 event option b, .*, position: antiquarian" debug.log | wc -l)"
echo "- travel_leader: $(grep -a "accou_courtier.0003 event option b, .*, position: travel_leader" debug.log | wc -l)"
echo "- wet_nurse: $(grep -a "accou_courtier.0003 event option b, .*, position: wet_nurse" debug.log | wc -l)"
echo "- court_tutor: $(grep -a "accou_courtier.0003 event option b, .*, position: court_tutor" debug.log | wc -l)"
echo "- food_taster: $(grep -a "accou_courtier.0003 event option b, .*, position: food_taster" debug.log | wc -l)"
echo "- master_of_horse: $(grep -a "accou_courtier.0003 event option b, .*, position: master_of_horse" debug.log | wc -l)"
echo "- master_of_hunt: $(grep -a "accou_courtier.0003 event option b, .*, position: master_of_hunt" debug.log | wc -l)"
echo "- royal_architect: $(grep -a "accou_courtier.0003 event option b, .*, position: royal_architect" debug.log | wc -l)"
echo "- high_almoner: $(grep -a "accou_courtier.0003 event option b, .*, position: high_almoner" debug.log | wc -l)"
echo "- seneschal: $(grep -a "accou_courtier.0003 event option b, .*, position: seneschal" debug.log | wc -l)"
echo "- cupbearer: $(grep -a "accou_courtier.0003 event option b, .*, position: cupbearer" debug.log | wc -l)"
echo "- chief_eunuch: $(grep -a "accou_courtier.0003 event option b, .*, position: chief_eunuch" debug.log | wc -l)"
echo "- court_jester: $(grep -a "accou_courtier.0003 event option b, .*, position: court_jester" debug.log | wc -l)"
echo "- court_poet: $(grep -a "accou_courtier.0003 event option b, .*, position: court_poet" debug.log | wc -l)"
echo "- court_musician: $(grep -a "accou_courtier.0003 event option b, .*, position: court_musician" debug.log | wc -l)"
echo "- bodyguard: $(grep -a "accou_courtier.0003 event option b, .*, position: bodyguard" debug.log | wc -l)"
echo "- champion: $(grep -a "accou_courtier.0003 event option b, .*, position: champion" debug.log | wc -l)"
echo "- executioner: $(grep -a "accou_courtier.0003 event option b, .*, position: executioner" debug.log | wc -l)"
echo "- court_artificer: $(grep -a "accou_courtier.0003 event option b, .*, position: court_artificer" debug.log | wc -l)"
echo "- court_cave_hermit: $(grep -a "accou_courtier.0003 event option b, .*, position: court_cave_hermit" debug.log | wc -l)"
echo "- master_assassin: $(grep -a "accou_courtier.0003 event option b, .*, position: master_assassin" debug.log | wc -l)"
echo "- court_scholar: $(grep -a "accou_courtier.0003 event option b, .*, position: court_scholar" debug.log | wc -l)"
echo "---"
echo

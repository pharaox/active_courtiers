...
The current version is compatible with CK3 1.15. If you are still on CK3 1.14.x, use [version 0.7.1](https://github.com/pharaox/active_courtiers/releases/download/0.7.1/active_courtiers-0.7.1.zip) instead.

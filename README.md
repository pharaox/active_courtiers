...
The main feature of this mod is the new **Courtier Requests to Marry** event. It is triggered for count or higher rulers, every year for players and every 1 to 3 years for the AI by default. These event frequencies can be changed via game rules.
...
The current version is compatible with CK3 1.12. If you are still on CK3 1.11.x, use [version 0.2.2](https://github.com/pharaox/active_courtiers/releases/download/0.2.2/active_courtiers-0.2.2.zip) instead.
